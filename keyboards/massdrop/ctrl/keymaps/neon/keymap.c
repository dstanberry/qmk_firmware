...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LGUI, KC_LCTL, KC_LALT,                   KC_SPC,                             KC_RALT, MO(1),   KC_APP,  KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [1] = LAYOUT(
...
led_instruction_t led_instructions[] = {
    ...
    //All LEDs use the user's selected pattern (this is the factory default)
     ...
     {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB,  .layer = 0, .r = 161, .g = 0, .b = 255},
     {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB,  .layer = 1, .r = 0, .g = 191, .b = 255},
